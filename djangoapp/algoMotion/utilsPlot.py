...
def plotLines(dots, axles, title=None, color=None, highlightIdx=None):
    fig = plt.figure()
    ...
    if 0 in axles:
        ...
        if highlightIdx is not None and len(highlightIdx) > 0:
            dots0 = dots[:, 0]
            print 'type(dots0):', type(dots0)
            s0.plot(xAxle[highlightIdx], dots0[highlightIdx], 'gD')
